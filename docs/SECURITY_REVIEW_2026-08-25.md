...
| Medium | Partial reconciliation scanned the newest 2,000 records and overwrote complete aggregates as if the partial result were complete. | Partial recount now refuses without writing; cron surfaces the failure; regression verifies aggregates remain untouched. |
